...
\begin{itemize}
	...
	\item if $\mu$ is a \textbf{dominant integral element}, there exists an irreducible, finite-dim. rep. of $\mathfrak{g}$ with \textbf{highest weight} $\mu$.
...
\section{construction of Verma modules}
\begin{itemize}
...
\section{irreducible quotient modules}
\begin{itemize}
